    ...
    <main className="min-h-screen px-4 py-8 sm:py-12">
      ...
      <article className="max-w-2xl mx-auto">
        <header className="mb-8">
          ...
          <h1 className="text-4xl font-bold mt-4 mb-3">Word List</h1>
        ...
        <section className="grid grid-cols-3 sm:grid-cols-4 gap-3 mb-10">
        ...
        <section className="mb-10 bg-surface/50 rounded-xl p-5">
